...
class TransactionLocalDataSourceImpl implements TransactionLocalDataSource {
  ...
  Future<void> addTransaction(TransactionEntity transaction) async {
    try {
      final box = Hive.box<legacy.TransactionModel>(boxName);
  ...
  TransactionEntity _modelToEntity(legacy.TransactionModel model) {
    return TransactionEntity(
      ...
      amount: model.amount,
      date: model.date,
      type: model.type == legacy.TransactionType.income
  ...
  legacy.TransactionModel _entityToModel(TransactionEntity entity) {
    return legacy.TransactionModel(
      id: entity.id,
      ...
      type: entity.type == TransactionType.income
          ? legacy.TransactionType.income
          : legacy.TransactionType.expense,
    );
  }
}
